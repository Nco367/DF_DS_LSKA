...
class PoseDataset(data.Dataset):
    def __init__(self, mode, num, add_noise, root, noise_trans, refine):
        ...
        self.cam_cx = 2038.63190
        self.cam_cy = 1408.83467
        self.cam_fx = 5070.07988
        self.cam_fy = 5142.08286

        # 创建地图
        self.xmap, self.ymap = np.meshgrid(np.arange(4000), np.arange(2700))
    ...
    def __getitem__(self, index):
        EVALUATION_RESULT='/media/q/SSD2T/1linux/Linemod5_eval/dataset_vis/'
