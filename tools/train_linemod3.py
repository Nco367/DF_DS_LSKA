...
parser.add_argument('--resume_posenet', type=str, default = '',  help='pose_model_current.pth')
parser.add_argument('--resume_refinenet', type=str, default = '',  help='pose_refine_model_current.pth')
