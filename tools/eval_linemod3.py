...
parser.add_argument('--model', type=str, default = '/media/q/SSD2T/1linux/Linemod3_trained_mod/DF——改进后500轮/pose_model_3_0.009872881446324725.pth',  help='resume PoseNet model')
parser.add_argument('--refine_model', type=str, default = '/media/q/SSD2T/1linux/Linemod3_trained_mod/DF——改进后500轮/pose_refine_model_current.pth',  help='resume PoseRefineNet model')
...
# 基础目录
base_dir = "/media/q/SSD2T/1linux/Linemod3_eval/evaluation_result/"
