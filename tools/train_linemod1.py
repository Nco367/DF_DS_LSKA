...
parser.add_argument('--refine_margin', default=0.014, help='margin to start the training of iterative refinement')
parser.add_argument('--noise_trans', default=0.03, help='range of the random noise of translation added to the training data')
parser.add_argument('--iteration', type=int, default = 2, help='number of refinement iterations')
parser.add_argument('--nepoch', type=int, default=500, help='max number of epochs to train')
parser.add_argument('--resume_posenet', type=str, default = '',  help='pose_model_current.pth      resume PoseNet model')
...
# 数据集参数设置
    if opt.dataset == 'ycb':
        ...
        opt.num_objects = 13
        opt.num_points = 500
        opt.outf = '/media/q/SSD2T/1linux/Linemod1_trained_mod' # 设置训练过程中保存模型的文件夹路径
        opt.log_dir = '/media/q/SSD2T/1linux/Linemod1_log' # 设置训练过程中日志保存的目录
